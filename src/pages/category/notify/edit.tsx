...
const EditFormNotify: React.FC<Props> = (props: Props) => {
...
type Props = {
    record?: DmNotifyDto,
    onEdit: (record: DmNotifyDto) => void
}
export default EditFormNotify;