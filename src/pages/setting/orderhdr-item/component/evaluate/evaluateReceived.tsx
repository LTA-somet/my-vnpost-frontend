...
const EvaluateReceived = (props: Props) => {
    ...
    const [checkedListDgcdv, setCheckedListDgcdv] = useState<CheckboxValueType[]>([]);
    const [checkedListDgp, setCheckedListDgp] = useState<CheckboxValueType[]>([]);

    // const [listConfigReview, setListConfigReview] = useState<ConfigReviewDto[]>([]);
    ...
    // const [countDgp, setCountDgp] = useState(0);
    // const [countDgcdv, setCountDgcdv] = useState(0);
    ...
    const loadRateDefault = (list: any) => {
        ...
        setDgcdvGoodList(tempList.filter((e: any) => e.ownerReview.split(',').map((value: string) => value === '2') && e.statusReviewTypeDetail === "1" && e.contentReview === "ORDER" && e.reviewType === "GOOD" && e.stageReview === "DGCDV"));
        setDgpGoodList(tempList.filter((e: any) => e.ownerReview.split(',').map((value: string) => value === '2') && e.statusReviewTypeDetail === "1" && e.contentReview === "ORDER" && e.reviewType === "GOOD" && e.stageReview === "DGP"));

        setDgcdvBadList(tempList.filter((e: any) => e.ownerReview.split(',').map((value: string) => value === '2') && e.statusReviewTypeDetail === "1" && e.contentReview === "ORDER" && e.reviewType === "BAD" && e.stageReview === "DGCDV"));
        setDgpBadList(tempList.filter((e: any) => e.ownerReview.split(',').map((value: string) => value === '2') && e.statusReviewTypeDetail === "1" && e.contentReview === "ORDER" && e.reviewType === "BAD" && e.stageReview === "DGP"));

        setIsCheckStatusDgp(funcCheckListStatus(tempList.filter((e: any) => e.ownerReview.split(',').map((value: string) => value === '2') && e.statusReviewTypeDetail === "1" && e.contentReview === "ORDER" && e.stageReview === "DGP")));
        setIsCheckStatusDgcdv(funcCheckListStatus(tempList.filter((e: any) => e.ownerReview.split(',').map((value: string) => value === '2') && e.statusReviewTypeDetail === "1" && e.contentReview === "ORDER" && e.stageReview === "DGCDV")));
    }
    ...
    const onChangeCheckBoxDgcdv = (list: CheckboxValueType[]) => {
        setCheckedListDgcdv(list);
    };

    const onChangeCheckBoxDgp = (list: CheckboxValueType[]) => {
        setCheckedListDgp(list);
    };
...

            {
                ...
                <>
                    ...
                    <Card extra={
                        ...
                        {isDgp &&
                            <Form name="form-evaluate-receiver-dgp"
                                labelWrap
                                labelAlign="left"
                                            ...
                                            }
                                            {
                                                valueRateDgp > 0 && <>
                                                    ...
                                                    <Row justify='center' style={{ marginTop: -30, marginBottom: 10 }}>
                                                        <Col>
                                                            <Button disabled={isDisableDgp} loading={isLoading} className='custom-btn4 btn-outline-success' icon={<SaveOutlined />} htmlType="submit" form="form-evaluate-receiver-dgp" size="large" >
                                                                Gửi đánh giá
                                                            </Button>
                                                        </Col>
                                                    </Row></>
            ...
            }
            {
                ...
                <>
                    ...
                    <Card extra={
                        ...
                        {isDgcdv &&
                            <Form name="form-evaluate-receiver-dgcdv"
                                labelWrap
                                labelAlign="left"
                                        ...
                                        <>
                                            ...
                                            }
                                            {
                                                valueRateDgcdv > 0 && <>
                                                    ...
                                                    <Row justify='center' style={{ marginTop: -30, marginBottom: 10 }}>
                                                        <Col>
                                                            <Button disabled={isDisableDgcdv} loading={isLoading} className='custom-btn4 btn-outline-success' icon={<SaveOutlined />} htmlType="submit" form="form-evaluate-receiver-dgcdv" size="large" >
                                                                Gửi đánh giá
                                                            </Button>
                                                        </Col>
                                                    </Row></>
...
export default EvaluateReceived;
