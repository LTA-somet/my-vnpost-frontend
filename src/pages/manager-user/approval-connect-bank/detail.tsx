...
const DetailFormApproval: React.FC<Props> = (props: Props) => {
    ...
    return (
        <div>
            <Modal
                title={<div style={{ fontSize: '16px' }}>{props.record ? 'Xem chi tiết thông tin tài khoản kết nối ngân hàng' : 'Khai báo thông tin tài khoản kết nối ngân hàng'}</div>}
